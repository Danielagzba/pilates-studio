...
export const metadata = {
  title: "Classes | Estudio Pilates",
  description: "Explore our Pilates classes for all levels, from beginners to advanced practitioners.",
}
      ...
      <section className="py-20 md:py-32">
        <div className="container px-4 md:px-6">
          <div className="grid gap-12 max-w-4xl mx-auto">
            {classes.map((cls) => (
              <div key={cls.id} className="grid md:grid-cols-2 gap-8 items-center">
                <div className="relative h-[400px] overflow-hidden">
                  <Image src={cls.image || "/placeholder.svg"} alt={cls.title} fill className="object-cover" />
                </div>
                <div>
                  <h2 className="font-serif text-2xl md:text-3xl font-light mb-4">{cls.title}</h2>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{cls.suitableFor}</p>
                    </div>
                    <div>
                      <h3 className="font-medium mb-2">What to Bring</h3>
                      <p className="text-sm text-muted-foreground">{cls.whatToBring}</p>
                    </div>
                  </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Find a class that fits your schedule. All classes must be booked in advance.
            </p>
          </div>
            ...
            <table className="w-full min-w-[600px] border-collapse max-w-3xl mx-auto">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="py-4 px-4 text-left font-medium">Morning Flow (7:30 AM)</th>
                  <th className="py-4 px-4 text-left font-medium">Evening Restore (6:00 PM)</th>
                </tr>
              </thead>
              <tbody>
                {schedule.map((day, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td className="py-4 px-4">{day.morning ? "✓" : "-"}</td>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Our private sessions offer personalized attention and customized programs tailored to your specific
                needs and goals. Whether you're recovering from an injury, preparing for a specific event, or simply
                prefer one-on-one instruction, Maria will guide you through a transformative Pilates experience.
              </p>
              <p className="text-muted-foreground mb-8">
                Private sessions are available by appointment and can be scheduled at your convenience. Contact us to
                discuss your needs and book your first session.
              </p>
              <Button asChild className="rounded-none">
      ...
      <section className="py-20 md:py-32 bg-stone-100">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Find answers to common questions about our classes and studio policies.
            </p>
          </div>
...
const classes = [
  {
    ...
    time: "7:30 AM (Monday-Friday)",
    duration: "55 minutes",
    suitableFor: "All levels, modifications provided for beginners and advanced practitioners",
  ...
  },
  {
    ...
    duration: "50 minutes",
    suitableFor: "All levels, perfect for stress relief and recovery",
    whatToBring: "Comfortable clothing, water bottle, socks (optional)",
  },
]

const schedule = [
  { name: "Monday", morning: true, evening: true },
  { name: "Tuesday", morning: true, evening: true },
  { name: "Wednesday", morning: true, evening: true },
  { name: "Thursday", morning: true, evening: true },
  { name: "Friday", morning: true, evening: true },
  { name: "Saturday", morning: true, evening: false },
  { name: "Sunday", morning: false, evening: false },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Please arrive 10-15 minutes before your first class to complete any necessary paperwork and receive an orientation. For subsequent classes, we recommend arriving 5 minutes early.",
  },
  {
    question: "What is your cancellation policy?",
    answer:
      "Classes must be cancelled at least 12 hours in advance to avoid being charged. You can cancel through our online booking system or by calling the studio.",
  },
  {
    question: "Do you offer package discounts?",
    answer:
      "Yes, we offer class packages of 5, 10, and 20 classes at discounted rates. We also offer monthly unlimited memberships for those who attend classes frequently.",
  },
]
