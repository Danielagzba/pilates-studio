  ...
  return (
    <div className="pt-16">
      <section className="py-20 md:py-32">
        <div className="container px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div>
              <h1 className="font-serif text-3xl md:text-4xl font-light mb-6">Contact <span className="font-medium italic">Us</span></h1>
              <p className="text-muted-foreground mb-8">
                We'd love to hear from you. Whether you have a question about our classes, want to book a private session, or are interested in learning more about Pilates, please don't hesitate to reach out.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">info@estudiopilates.mx</p>
                  </div>
                </div>
            ...
            <div>
              <div className="bg-stone-100 p-8">
                <h2 className="font-serif text-2xl font-light mb-6">Send Us a <span className="font-medium italic">Message</span></h2>
      ...
      <section className="h-[400px] relative">
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3762.7603513183!2d-99.16978492526186!3d19.419293941858!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ff35f5bd1563%3A0x6c366f0e2de02ff7!2sC.%20Durango%20216%2C%20Roma%20Nte.%2C%20Cuauht%C3%A9moc%2C%2006700%20Ciudad%20de%20M%C3%A9xico%2C%20CDM\
