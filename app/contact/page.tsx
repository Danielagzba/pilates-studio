          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div>
              <h1 className="font-serif text-3xl md:text-4xl font-light mb-6">
                Contact <span className="font-medium italic">Us</span>
              </h1>
              <p className="text-muted-foreground mb-8">
                We'd love to hear from you. Whether you have a question about
                our classes, want to book a private session, or are interested
                in learning more about Pilates, please don't hesitate to reach
                out.
              </p>
            ...
            <div>
              <div className="bg-stone-100 p-8">
                <h2 className="font-serif text-2xl font-light mb-6">
                  Send Us a <span className="font-medium italic">Message</span>
                </h2>
